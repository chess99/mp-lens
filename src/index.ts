...
if (require.main === module) {
  console.log('mp-analyzer 是一个命令行工具，请使用以下方式运行:');
  console.log('  npx mp-analyzer <命令> [选项]');
  console.log('');
  console.log('示例:');
  console.log('  npx mp-analyzer list-unused');
  console.log('  npx mp-analyzer graph');
  console.log('  npx mp-analyzer clean --dry-run');
  console.log('');
